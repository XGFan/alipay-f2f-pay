 ...
 */
object SandBox {
    const val APPID = "2016080300158457"

    const val PRIVATEKEY: String = "MIIEvwIBADANBgkqhkiG9w0BAQEFAASCBKkwggSlAgEAAoIBAQC2qz3Uu8zB/4EQdiHz" +
    ...
    const val ALIPAYPUBLICKEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAxYmJXuonTn6JU2v5qkZZ49Ufr/L" +
    ...
    const val APIGATEWAY: String = "https://openapi.alipaydev.com/gateway.do"
